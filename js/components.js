    ...
    <nav class="nav" role="navigation" aria-label="Main navigation">
      <div class="container nav__inner">
        <a href="../index.html" class="nav__logo" aria-label="Partners Pest Solutions - Home">
          <img src="../images/logo.jpg" alt="Partners Pest Solutions logo" width="48" height="48">
        </a>
        ...
        <ul class="nav__links" role="list">
          ...
          <li><a class="nav__link" href="../pages/general-pest.html"  data-page="general-pest.html">General Pest</a></li>
          <li><a class="nav__link" href="../pages/termite.html"       data-page="termite.html">Termites</a></li>
          <li><a class="nav__link" href="../pages/rodent.html"        data-page="rodent.html">Rodents</a></li>
          ...
          <li class="nav__cta">
            <a class="btn btn-primary" href="https://app.fieldworkhq.com/portal/YOUR-COMPANY-ID" target="_blank" rel="noopener">
              Pay My Bill
            </a>
          </li>
        </ul>
      ...
      <div class="container">
        <div class="footer__grid">
          <div>
            ...
            <p class="footer__tagline">Protecting homes and businesses with professional pest solutions. Licensed, insured, and family owned.</p>
          </div>
          <div>
            <p class="footer__heading">Services</p>
            <ul class="footer__links">
              <li><a class="footer__link" href="../pages/general-pest.html">General Pest Control</a></li>
              <li><a class="footer__link" href="../pages/termite.html">Termite Control</a></li>
          ...
          <div>
            ...
            <ul class="footer__links">
              ...
              <li><a class="footer__link" href="../pages/contact.html">Request Inspection</a></li>
              <li><a class="footer__link" href="https://app.fieldworkhq.com/portal/YOUR-COMPANY-ID" target="_blank" rel="noopener">Pay My Bill</a></li>
            </ul>
          </div>
          <div>
            <p class="footer__heading">Contact</p>
            <ul class="footer__links">
              <li><a class="footer__link" href="tel:+10000000000">(000) 000-0000</a></li>
